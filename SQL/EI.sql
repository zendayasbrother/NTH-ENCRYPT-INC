-- ====================================================================
-- 1. INITIALIZE SCHEMA ENVIRONMENT
-- ====================================================================
CREATE SCHEMA IF NOT EXISTS "Notation";

SET search_path TO "Notation";
...
CREATE TABLE "Notation"."Pods" (
    ...
    "AdminID" INTEGER REFERENCES "Notation"."Users"("UserID") ON DELETE PROTECT,
    "CreatorID" INTEGER REFERENCES "Notation"."Users"("UserID") ON DELETE PROTECT,
...
CREATE TABLE "Notation"."Payroll" (
    ...
    "NetPay" NUMERIC(12, 2) GENERATED ALWAYS AS ("GrossPay" - ("Tax" + "Insurance")) STORED,
...
-- 6. DATA POPULATION
-- ====================================================================
INSERT INTO "Notation"."Niches" ("NicheName") VALUES 
('Lifestyle'), ('Food'), ('Fashion'), ('Comedy'), ('Art'), ('Tech');
